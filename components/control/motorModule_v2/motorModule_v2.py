...
commands = {
    1: ('cw', 90),  # Motor 1, rotate clockwise 90 degrees
    2: ('ccw', 180),  # Motor 2, rotate counterclockwise 180 degrees
    3: ('cw', 270)  # Motor 3, rotate clockwise 270 degrees
}
controller.control_motors(commands)
"""