...
def moveRobot(position):
    ...
    if position ==1:
        ...
        # Uç efektörü [3. Bölgeye] hareket ettir.
        commands4_1 = {
            1: ('cw', 80),   # Motor 1, rotate cw,  degrees 
            2: ('cw', 80),     #  Motor 2, rotate cw,  degrees
            3: ('cw', 80)     #  Motor 3, rotate cw,  degrees
            }
        robot.control_motors(commands4_1)
        
        time.sleep(1)  # Hareketlerin tamamlanması için bir süre bekle

        # Uç efektörü [Hedef Bölgeye] hareket ettir.
        commands4_2 = {
            1: ('ccw', 60),   # Motor 1, rotate ccw,  degrees 
            2: ('ccw', 60),     #  Motor 2, rotate ccw,  degrees
            3: ('ccw', 60)     #  Motor 3, rotate ccw,  degrees
            }
        robot.control_motors(commands4_2)
